...
#define HF_FUNCTIONAL_GPIO_PIN_LIST(X) \
    ...
    /* TMC chip (direction, output level, TMCL), use TMC_GPIO17 / TMC_GPIO18 via Tmc9660Handler after */ \
    /* MotorController::RegisterTmc9660BridgePinsIfNeeded(); both views see the same nets. */ \
    X(PCAL_TMC_FAULT_STATUS, "GPIO_PCAL_TMC_FAULT_STATUS", HfPinCategory::PIN_CATEGORY_GPIO, HfGpioChipType::PCAL95555_EXPANDER, 0, 0, 3, PIN_LOGIC_INVERTED, PIN_NO_PULL, PIN_PULL_DOWN, PIN_PUSH_PULL, 25) \
    X(PCAL_TMC_DRV_EN, "GPIO_PCAL_TMC_DRV_EN", HfPinCategory::PIN_CATEGORY_GPIO, HfGpioChipType::PCAL95555_EXPANDER, 0, 0, 4, PIN_LOGIC_NORMAL, PIN_NO_PULL, PIN_PULL_DOWN, PIN_PUSH_PULL, 25) \
    X(PCAL_TMC_RST_CTRL, "GPIO_PCAL_TMC_RST_CTRL", HfPinCategory::PIN_CATEGORY_GPIO, HfGpioChipType::PCAL95555_EXPANDER, 0, 0, 5, PIN_LOGIC_NORMAL, PIN_NO_PULL, PIN_PULL_DOWN, PIN_PUSH_PULL, 25) \
    ...
    X(PCAL_TMC_GPIO18_EXP_IN, "GPIO_PCAL_TMC_GPIO18_EXP_IN", HfPinCategory::PIN_CATEGORY_GPIO, HfGpioChipType::PCAL95555_EXPANDER, 0, 0, 2, PIN_LOGIC_NORMAL, PIN_NO_PULL, PIN_PULL_DOWN, PIN_PUSH_PULL, 25) \
    \
    /* TMC9660 GPIO17/18 — Hal bridge to handler->gpio(17|18); same nets as PCAL_TMC_GPIO17/18_EXP_IN. */ \
